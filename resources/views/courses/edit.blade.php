        ...
        <div class="content-body height-100 p-4">
            <div class="col-lg-12">
                ...
                <form action="{{route('courses.update',$course->id)}}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="course_code" value="{{$course->course_code}}" placeholder="Course Code" aria-label="City">
                        </div>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="course_name" value="{{$course->course_name}}" placeholder="Course" aria-label="State">
                        </div>
                        <div class="col-sm">
                            <input type="text" class="form-control" name="units" value="{{$course->units}}" placeholder="Units" aria-label="Zip">
                        </div>
                        <div class="col-sm-12">
                            <textarea id="example" name="course_description">{{$course->course_description}}</textarea>
                        </div>
                        <div class="col-auto">
