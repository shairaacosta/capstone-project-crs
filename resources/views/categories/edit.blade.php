            ...
            <div class="col-6">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('categories.index')}}">Category Management</a></li>
        ...
        <div class="content-body height-100 p-4">
            <div class="col-lg-12">
                ...
                <form action="{{route('categories.update',$category->id)}}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="category_name" value="{{$category->category_name}}" placeholder="Category" aria-label="State">
                        </div>
                        <div class="col-auto">
